package Booking.core.generated
...
import Booking.core.api
import Booking.core.createComponents
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = Booking.core.api as Api<T>
    override val config: ApplicationConfig = Booking.core.config
}
